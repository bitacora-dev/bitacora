...
// PackageOperation is deliberately a closed set. It is the entire action
// vocabulary ADR-0022 permits the hub to request from an agent.
type PackageOperation int32

const (
	PackageOperation_PACKAGE_OPERATION_UNSPECIFIED PackageOperation = 0
	PackageOperation_REFRESH_PACKAGE_CACHE         PackageOperation = 1
	PackageOperation_APPLY_PENDING_PACKAGE_UPDATES PackageOperation = 2
)

// Enum value maps for PackageOperation.
var (
	PackageOperation_name = map[int32]string{
		0: "PACKAGE_OPERATION_UNSPECIFIED",
		1: "REFRESH_PACKAGE_CACHE",
		2: "APPLY_PENDING_PACKAGE_UPDATES",
	}
	PackageOperation_value = map[string]int32{
		"PACKAGE_OPERATION_UNSPECIFIED": 0,
		"REFRESH_PACKAGE_CACHE":         1,
		"APPLY_PENDING_PACKAGE_UPDATES": 2,
	}
)

func (x PackageOperation) Enum() *PackageOperation {
	p := new(PackageOperation)
	*p = x
	return p
}

func (x PackageOperation) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (PackageOperation) Descriptor() protoreflect.EnumDescriptor {
	return file_proto_ingest_proto_enumTypes[0].Descriptor()
}

func (PackageOperation) Type() protoreflect.EnumType {
	return &file_proto_ingest_proto_enumTypes[0]
}

func (x PackageOperation) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use PackageOperation.Descriptor instead.
func (PackageOperation) EnumDescriptor() ([]byte, []int) {
...
// Job is a completed scheduled operation. Statistics are intentionally absent
// when the producer cannot state them reliably.
type Job struct {
	state          protoimpl.MessageState `protogen:"open.v1"`
	Id             string                 `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`
	...
	PeerHostId     string                 `protobuf:"bytes,10,opt,name=peer_host_id,json=peerHostId,proto3" json:"peer_host_id,omitempty"`
	Trigger        string                 `protobuf:"bytes,11,opt,name=trigger,proto3" json:"trigger,omitempty"`
	NextExpectedMs int64                  `protobuf:"varint,12,opt,name=next_expected_ms,json=nextExpectedMs,proto3" json:"next_expected_ms,omitempty"`
	Schema         int32                  `protobuf:"varint,13,opt,name=schema,proto3" json:"schema,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *Job) GetStartedAtMs() int64 {
	if x != nil {
...
func (x *Job) GetDurationMs() int64 {
	if x != nil {
		return x.DurationMs
	}
	return 0
...
func (x *Job) GetPeerHostId() string {
	if x != nil {
		return x.PeerHostId
	}
	return ""
...
func (x *Job) GetNextExpectedMs() int64 {
	if x != nil {
		return x.NextExpectedMs
	}
	return 0
}

func (x *Job) GetSchema() int32 {
	if x != nil {
		return x.Schema
	}
	return 0
...
// PendingPackageOperation carries no executable input. The operation is an
// enum, while request_id identifies the human-confirmed request and expiry
// lets the agent reject stale requests before they can reach a helper.
type PendingPackageOperation struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Operation     PackageOperation       `protobuf:"varint,1,opt,name=operation,proto3,enum=bitacora.v1.PackageOperation" json:"operation,omitempty"`
...
func (x *PendingPackageOperation) Reset() {
	*x = PendingPackageOperation{}
	mi := &file_proto_ingest_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *PendingPackageOperation) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PendingPackageOperation) ProtoMessage() {}

func (x *PendingPackageOperation) ProtoReflect() protoreflect.Message {
	mi := &file_proto_ingest_proto_msgTypes[9]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PendingPackageOperation.ProtoReflect.Descriptor instead.
func (*PendingPackageOperation) Descriptor() ([]byte, []int) {
	return file_proto_ingest_proto_rawDescGZIP(), []int{9}
}

func (x *PendingPackageOperation) GetOperation() PackageOperation {
	if x != nil {
		return x.Operation
	}
	return PackageOperation_PACKAGE_OPERATION_UNSPECIFIED
}

func (x *PendingPackageOperation) GetRequestId() string {
	if x != nil {
		return x.RequestId
	}
	return ""
...
func (x *PendingPackageOperation) GetExpiresAtMs() int64 {
	if x != nil {
...
type IngestResponse struct {
	...
	PendingPackageOperation *PendingPackageOperation `protobuf:"bytes,3,opt,name=pending_package_operation,json=pendingPackageOperation,proto3" json:"pending_package_operation,omitempty"`
	unknownFields           protoimpl.UnknownFields
	sizeCache               protoimpl.SizeCache
}
...
func (x *IngestResponse) GetPendingPackageOperation() *PendingPackageOperation {
	if x != nil {
		return x.PendingPackageOperation
	}
	return nil
}
...
const file_proto_ingest_proto_rawDesc = "" +
	...
	"\x05items\x18\x05 \x03(\v2\x1a.bitacora.v1.InventoryItemR\x05items\"\xff\x02\n" +
	"\x03Job\x12\x0e\n" +
	...
	"\x0efinished_at_ms\x18\x05 \x01(\x03R\ffinishedAtMs\x12\x1f\n" +
	...
	" \x01(\tR\n" +
	"peerHostId\x12\x18\n" +
	"\atrigger\x18\v \x01(\tR\atrigger\x12(\n" +
	"\x10next_expected_ms\x18\f \x01(\x03R\x0enextExpectedMs\x12\x16\n" +
	"\x06schema\x18\r \x01(\x05R\x06schema\"\xa9\x02\n" +
	"\x05Batch\x12\x19\n" +
	...
	"\vinventories\x18\x06 \x03(\v2\x16.bitacora.v1.InventoryR\vinventories\x12$\n" +
	"\x04jobs\x18\a \x03(\v2\x10.bitacora.v1.JobR\x04jobs\"\x99\x01\n" +
	"\x17PendingPackageOperation\x12;\n" +
	"\toperation\x18\x01 \x01(\x0e2\x1d.bitacora.v1.PackageOperationR\toperation\x12\x1d\n" +
	"\n" +
	"request_id\x18\x02 \x01(\tR\trequestId\x12\"\n" +
	"\rexpires_at_ms\x18\x03 \x01(\x03R\vexpiresAtMs\"\xb1\x01\n" +
	"\x0eIngestResponse\x12\x1f\n" +
	"\vlast_offset\x18\x01 \x01(\tR\n" +
	"lastOffset\x12\x1c\n" +
	"\tduplicate\x18\x02 \x01(\bR\tduplicate\x12`\n" +
	"\x19pending_package_operation\x18\x03 \x01(\v2$.bitacora.v1.PendingPackageOperationR\x17pendingPackageOperation*s\n" +
	"\x10PackageOperation\x12!\n" +
	"\x1dPACKAGE_OPERATION_UNSPECIFIED\x10\x00\x12\x19\n" +
	"\x15REFRESH_PACKAGE_CACHE\x10\x01\x12!\n" +
	"\x1dAPPLY_PENDING_PACKAGE_UPDATES\x10\x02B3Z1github.com/bitacora-dev/bitacora/proto/bitacorapbb\x06proto3"
...
var file_proto_ingest_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_proto_ingest_proto_msgTypes = make([]protoimpl.MessageInfo, 14)
var file_proto_ingest_proto_goTypes = []any{
	(PackageOperation)(0),           // 0: bitacora.v1.PackageOperation
	(*Metric)(nil),                  // 1: bitacora.v1.Metric
	(*EventSubject)(nil),            // 2: bitacora.v1.EventSubject
	(*LogRef)(nil),                  // 3: bitacora.v1.LogRef
	(*Event)(nil),                   // 4: bitacora.v1.Event
	(*LogLine)(nil),                 // 5: bitacora.v1.LogLine
	(*InventoryItem)(nil),           // 6: bitacora.v1.InventoryItem
	(*Inventory)(nil),               // 7: bitacora.v1.Inventory
	(*Job)(nil),                     // 8: bitacora.v1.Job
	(*Batch)(nil),                   // 9: bitacora.v1.Batch
	(*PendingPackageOperation)(nil), // 10: bitacora.v1.PendingPackageOperation
	(*IngestResponse)(nil),          // 11: bitacora.v1.IngestResponse
	nil,                             // 12: bitacora.v1.Metric.LabelsEntry
	nil,                             // 13: bitacora.v1.Event.AttrsEntry
	nil,                             // 14: bitacora.v1.InventoryItem.AttrsEntry
}
var file_proto_ingest_proto_depIdxs = []int32{
	12, // 0: bitacora.v1.Metric.labels:type_name -> bitacora.v1.Metric.LabelsEntry
	2,  // 1: bitacora.v1.Event.subject:type_name -> bitacora.v1.EventSubject
	13, // 2: bitacora.v1.Event.attrs:type_name -> bitacora.v1.Event.AttrsEntry
	3,  // 3: bitacora.v1.Event.log_refs:type_name -> bitacora.v1.LogRef
	14, // 4: bitacora.v1.InventoryItem.attrs:type_name -> bitacora.v1.InventoryItem.AttrsEntry
	6,  // 5: bitacora.v1.Inventory.items:type_name -> bitacora.v1.InventoryItem
	1,  // 6: bitacora.v1.Batch.metrics:type_name -> bitacora.v1.Metric
	4,  // 7: bitacora.v1.Batch.events:type_name -> bitacora.v1.Event
	5,  // 8: bitacora.v1.Batch.log_lines:type_name -> bitacora.v1.LogLine
	7,  // 9: bitacora.v1.Batch.inventories:type_name -> bitacora.v1.Inventory
	8,  // 10: bitacora.v1.Batch.jobs:type_name -> bitacora.v1.Job
	0,  // 11: bitacora.v1.PendingPackageOperation.operation:type_name -> bitacora.v1.PackageOperation
	10, // 12: bitacora.v1.IngestResponse.pending_package_operation:type_name -> bitacora.v1.PendingPackageOperation
